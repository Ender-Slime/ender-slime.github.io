...
document.querySelectorAll("area").forEach(area => {
  ...
  area.addEventListener("mouseover", event => {
    document.getElementById("hsmap").src = area.dataset.hover
  })
	// Change the image source back to it's original source
  area.addEventListener("mouseout", event => {
    document.getElementById("hsmap").src = "https://file.garden/YtMQu7utTE5LCcaH/neocities/hsprojects/hsprojectsbase.png"
  })
})